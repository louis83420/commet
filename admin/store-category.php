...
//获取数据
$array['category_name'] = $_POST['category_name'];
$array['sort_number'] = $_POST['sort_number'];
$array['created_at'] = time();
$array['updated_at'] = time();
//插入记录
$affectedRows = insert('coding_category', $array);
?>
<!DOCTYPE html>
<html>
    <head>
            ...
            <div class="main-content">
                <div class="main-content-inner">
                    ...
                    <div class="page-content">
                        <div class="row">
                            <div class="col-xs-12">
                                <?php if ($affectedRows !== false) {?>
                                <!-- 文章分类添加成功时显示的HTML代码段开始 -->
                                <div class="alert alert-block alert-success">
                                    ...
                                    <div class="hr"></div>
                                    <p>
                                        <a href="create-category.php">添加分类</a>
                                        &nbsp;/&nbsp;
                                        <a href="list-category.php">分类列表</a>
                                        &nbsp;/&nbsp;
                                        <a href="create-article.php">发表文章</a>
                                    </p>
                                </div>
                                <!-- 文章分类添加成功时显示的HTML代码段结束 -->
                                <?php } else {?>
                                <!-- 文章分类添加失败时显示的HTML代码段开始 -->
