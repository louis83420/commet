					...
					<div class="page-content">
						<div class="row">
							<div class="col-xs-12">
								...
								<!-- 修改个人资料表单区域开始 -->
								<form action="update-user-profile.php" method="post" enctype="multipart/form-data" onsubmit="return checkUseProfileForm()">
									<table class="table table-bordered">
										<tr>
											<td>头像</td>
											<td>
												<div class="col-xs-6">
													<input type="file" name="user-face">
												</div>
											</td>
										</tr>
										<tr>
											...
											<td>
												<div class="col-xs-6">
													<input type="text" name="nick_name" id="nick_name" class="input-large">
												</div>
											</td>
										</tr>
										<tr>
