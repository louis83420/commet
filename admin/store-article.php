...
$data['admin_id'] = 1;
//文件上传
$uploadedFiles = upload('../public/images/thumbs');
$data['subject_picture'] = join(null, $uploadedFiles);
//插入记录
$affectedRows = insert('coding_article', $data);
                            ...
                            <?php if ($affectedRows !== false) { ?>
                                ...
                                <div class="alert alert-block alert-success">
                                    ...
                                    <p>
                                        ...
                                        &nbsp;/&nbsp;
                                        <a href="../varticle.php?id=<?php echo $lastId ?>" target="_blank">查看文章</a>
                                    </p>
                                </div>
                                <!-- 文章发表成功时显示的HTML代码段结束 -->
                            <?php } else { ?>
