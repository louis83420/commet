...
$rowset = select('coding_category', ['fields' => 'id,category_name']);
            ...
            <div class="main-content-inner">
                ...
                <div class="page-content">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <!-- 发表文章表单区域开始 -->
                            <form action="store-article.php" method="post" enctype="multipart/form-data" onsubmit="return checkForm()">
                                <table class="table  table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php } else { ?>
                                                <!-- 不存在分类时，显示的HTML代码段开始 -->
                                                <div class="col-xs-6 line-height-34">
