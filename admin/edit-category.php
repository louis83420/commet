...
$row = selectOne('coding_category', ['fields' => 'id,category_name,sort_number', 'where' => 'id=' . $id]);
?>
<!DOCTYPE html>
<html>
    <head>
        ...
        <script>
            function checkForm(){
                ...
                if(categoryNameEle.value == ''){
                    window.alert('分类名称为必填项');
                    return false;
                }
                if(sortNumberEle.value == ''){
                    window.alert('排序数字为必填项');
                    return false;
                }
                if(isNaN(parseInt(sortNumberEle.value))){
                    window.alert('排序数字只能为整数');
                    return false;
                }
                return true;
            }
                ...
                <div class="main-content-inner">
                    ...
                    <div class="page-content">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <!-- 编辑分类表单区域开始 -->
                                <form action="update-category.php?id=<?php echo $id ?>" method="post" onsubmit="return checkForm()">
                                    <table class="table  table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="col-xs-4">
                                                    <input type="text" name="sort_number" id="sort_number" class="form-control" value="<?php echo $row['sort_number'] ?>">
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
